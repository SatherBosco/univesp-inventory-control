...
const produtosLista = [
  {
    ação2: (
      <Button className="text-red-700 font-semibold" variant="link">
        Editar
      </Button>
    ),
    nome: "Produto01",
...
export function Movimentacao() {
  ...
  const [produtos, setProdutos] = React.useState(produtosLista);
          ...
          <TableBody>
            {produtos.map((produto, index) => (
              <TableRow
                key={produto.nome}
                className={
                  produto.quantidade > produto.estoque_mínimo
                    ? "bg-white"
                    : "bg-red-100"
                }
              >
                <TableCell className="w-72">
                  <Drawer>
                    <DrawerTrigger>
                      <Button variant="link" onClick={() => setItem (index)}>
                        Movimentar
                      </Button>{" "}
                      <span className="separator">|</span> {produto.ação2}
                    </DrawerTrigger>
                    <DrawerContent>
                      <div className="mx-auto w-full max-w-sm">
                        <DrawerHeader>
                          ...
                          <DrawerDescription className="flex-1 text-center">
                            Alterar estoque
                          </DrawerDescription>
                        </DrawerHeader>
                        <div className="p-4 pb-0">
                          <div className="flex items-center justify-center space-x-2">
                            <Button
                              ...
                              variant="outline"
                              onClick={() => {
                                const novoProduto = produtos[item];
